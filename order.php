...
<html>
   <head>
      ...
      <script type="text/javascript" src="js/ctrl/ctrl_order.js"></script>
   </head>
   <body onload="ActiveModule();">
      <div id="wrapper">
         <input type="hidden" name="hTable" id="hTable" value="order">
         <?php sideBar(); ?>
                  ...
                  <div id="list">
                     <div class="panel-group">
                        <div class="panel-design">
                           <div class="panel-top">MAKE AN ORDER</div>
                           <div class="panel-mid">
                              <div class="row">
                                 <div class="col-xs-9">
                                    <table id="dataList" style="color:#000;" class="table table-striped table-bordered table-hover">
                                       ...
                                       <tbody>
                                          ...
                                          <tr>
                                             ...
                                             <td class="text-center">
                                                <button type="button" class="btn btn-info" id="action_<?php echo $row["DonutRefId"]; ?>">PURCHASE</button>
                                             </td>
                                          </tr>
                                          <?php
                                                }
