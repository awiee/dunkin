<?php
   ...
   $sql = "SELECT * FROM delivery WHERE EmployeesRefId = $EmployeesRefId AND branchRefId = $BranchRefId AND Status = 'C' AND RequestDate = '$date_today'";
...
<div class="row margin-top" style="padding: 1%;">
   <div class="panel-group">
      ...
      <div class="panel-design">
         <div class="panel-top">
            ...
            <div class="row margin-top">
               <div class="col-xs-12">STATUS: <strong>CANCELLED</strong></div>
            </div>
            <div class="row margin-top">
      ...
      <?php
            ...
            echo '<h4><label>NO CANCELLED REQUEST</label></h4>';
         }
      ?>
   </div>
</div>
